...
namespace implementations.common.http
{
    ///<summary>
    ///上传事件委托
    ///</summary>
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, implementations.common.http.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, implementations.common.http.DownloadEventArgs e);
