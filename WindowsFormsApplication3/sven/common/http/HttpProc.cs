...
namespace sven.common.http
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, sven.common.http.UploadEventArgs e);
    ...
    ///<param name="sender"></param>
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, sven.common.http.DownloadEventArgs e);
